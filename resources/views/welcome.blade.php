...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{asset('home/assets/vendor/')}}//aos.css" rel="stylesheet">
...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">ayon222@gmail.com</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+880-1791205437</span></i>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Ayon<span></span></a></h1>
      {{-- <a href="index.html" class="logo"><img src="{{asset('home/assets/img/')}}/logo.png" alt=""></a> --}}
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          @else
          <li><a class="btn btn-info p-2" href="{{ route('get_login') }}">Login</a></li>
          @endauth
        </ul>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Mehedi Hasan<span>.</span></h3>
            <p>

             Dhaka,Uttara<br>
             Bangladesh <br>
             <br><br>
              <strong>Phone:</strong> +880-179120547<br>
              <strong>Email:</strong> mh.ayon222@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>Ayon</span></strong>. All Rights Reserved
      </div>
      <div class="credits">

        Designed by <a href="#">Mehedi Hasan</a>
      </div>
    </div>
  </footer><!-- End Footer -->
